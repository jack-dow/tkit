...
const DropdownMenuContent = React.forwardRef<
	...
	React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.Content> & { withoutPortal?: boolean }
>(({ className, sideOffset = 4, withoutPortal = false, ...props }, ref) => {
	const Content = (
		<DropdownMenuPrimitive.Content
			...
			className={cn(
				...
				!className?.includes("data-[state=closed]:animate-") && "data-[state=closed]:animate-out",
				className,
			)}
			{...props}
		/>
