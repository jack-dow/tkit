	...
	return (
		<li>
			<div className={cn("relative flex justify-between", isLast ? "pb-8" : "pb-10")}>
				{!isLast ? <span className="absolute left-5 top-5 -ml-px h-full w-0.5 bg-zinc-200" aria-hidden="true" /> : null}

				<div className="relative flex items-start space-x-3">
					<div className="relative flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-full bg-zinc-100 ring-8 ring-white">
						{booking.assignedTo ? (
